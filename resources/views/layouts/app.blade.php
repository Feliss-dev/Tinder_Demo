        ...
        <div class="flex h-full">
            ...
            <aside class=" flex flex-col  bg-gray-100 sm:w-[25rem] w-full">
                <header class="bg-tinder py-5 flex items-center p-2.5 sticky top-0">
                    Avatar
                    <x-avatar class="w-10 h-10 ml-2" src="{{ auth()->user()->profile_photo_url }}" alt="{{ auth()->user()->name }}" />
                    <div class="ml-auto flex items-center gap-3">
                        ...
                        <span class="bg-black/40 p-2.5 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill  w-5 h-5" viewBox="0 0 16 16">
