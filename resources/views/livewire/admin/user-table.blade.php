        ...
        <table class="min-w-full table-auto border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-3 ">{{ $user->dating_goal }}</td>
                    <td class="px-4 py-3 ">
                        <button class="bg-blue-500 mb-2 hover:bg-blue-600 text-white py-1 px-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" wire:click="sendNotification({{ $user->id }})">
                            Send Notification
                        </button>
