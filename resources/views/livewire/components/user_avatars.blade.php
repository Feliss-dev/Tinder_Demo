...
<div class="mt-8">
    ...
    <h3 class="text-xl font-semibold text-gray-700 mb-4 text-center">{{__('view_my_details.avatar.your_avatars')}}</h3>
    ...
    <div class="flex flex-row overflow-x-auto overflow-y-hidden whitespace-nowrap gap-2">
        ...
        @foreach ($user->avatars()->orderByDesc('created_at')->get() as $avatar)
