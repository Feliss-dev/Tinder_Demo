                    ...
                    <main>
                        ...
                        <aside class="px-2" x-show="tab=='1'">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <div wire:click="createConversation('{{$match->id}}')" class="relative cursor-pointer">
                                    ...
                                    <h5 class="absolute rounded-lg left-2 bottom-2 text-white font-bold text-xs">
                        ...
                        <aside class="px-2" x-cloak x-show="tab=='2'">
                            <ul>
                                ...
                                <li>
                                    <a @class(['flex items-center gap-4 p-2 ', 'border-r-4 border-red-500 bg-white py-3'=>$i==3?true:false])
