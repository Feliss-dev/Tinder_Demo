            ...
            <form action="" x-data="{ body: @entangle('body') }" @submit.prevent="$wire.sendMessage()" autocomplete="off">
                ...
                <div class="grid grid-cols-12 items-center">
                    ...
                    <button x-bind@disabled="!body?.trim()" type="submit"
                        class="col-span-2n p-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all duration-300">Send</button>
                </div>
            </form>
        </footer>
    </main>
    ...
    <aside class="w-[50%] hidden sm:flex border">
        ...
        <div style="contain: content"
            ...
            <section class="grid gap-4 p-3">
                ...
                <!-- Relationships Goals -->
                <div class="rounded-lg bg-green-100 h-auto px-6 py-4 max-w-md flex gap-6 items-center shadow-lg">
