...
class PicsumPhotoProvider extends BaseProvider
{
    protected static $baseUrl = "https://picsum.photos/";

    public static function picsumUrl(int $width = 640, int $height = 480, $specificOrSeed=null, $grayscale=null, $blur=null, $file_ending=null)
    {
